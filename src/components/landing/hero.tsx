...
export function Hero() {
  ...
  return (
    <section className="relative w-full pt-12 md:pt-24 lg:pt-32 xl:pt-48 pb-12 md:pb-24 lg:pb-32 overflow-hidden bg-background">
      <Header />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="lg:order-2 flex flex-col items-center text-center lg:items-start lg:text-left space-y-6">
            <div className="flex flex-col justify-center space-y-4 text-foreground">
              ...
              <p className="max-w-[700px] mx-auto lg:mx-0 text-base md:text-lg text-muted-foreground">
