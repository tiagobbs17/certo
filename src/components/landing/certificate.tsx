      ...
      <div className="container grid items-center justify-center gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-16">
        <div className="space-y-4">
          ...
          <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed">
            Al completar el curso, recibirás un certificado con validez nacional, respaldado por la ABED (Asociación Brasileña de Educación a Distancia), que acredita tus nuevas habilidades como especialista en panetones.
          </p>
        ...
        <div className="flex justify-center">
          {certificateImage && (
            <Image
              ...
              width="550"
              height="350"
              alt="Certificado de Conclusión del Curso Panettone Pro"
