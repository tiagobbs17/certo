...
const benefits = [
  {
    ...
    title: 'Bolos Artesanales',
    description: 'Hacer bolos artesanales, con recetas tradicionales y gourmet.',
  },
  {
    icon: <Zap className="h-8 w-8 text-primary" />,
    title: 'Técnicas Profesionales',
    description: 'Técnicas de preparación de la masa y horneado, garantizando bolos suaves y sabrosos.',
  },
  {
  ...
  },
  {
    ...
    description: 'Desarrollar tu propio negocio de bolos artesanales, ofreciendo productos exclusivos.',
  },
];
